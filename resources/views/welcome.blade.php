...
<section style="padding-top: 40px; padding-bottom: 0; background: white;">
    <div class="container" style="text-align: center;">
        <img src="{{ asset('images/hero-image.png') }}" alt="SECRET DIARY Hero" style="max-width: 100%; height: auto; display: block; margin: 0 auto;">
    </div>
</section>
    ...
    <div class="container">
        <div style="display: flex; align-items: center; gap: 40px; flex-wrap: wrap;">
            <div style="flex: 1; min-width: 300px;">
                <img src="{{ asset('images/second-section.png') }}" alt="SECRET DIARY Second Section" style="max-width: 100%; height: auto; display: block;">
            </div>
            <div style="flex: 1; min-width: 300px;">
...
<section style="padding: 80px 0; background: #F8E8E8;">
    <div class="container">
        ...
        @if($anonymousEntries && $anonymousEntries->count() > 0)
            ...
            @else
                <div style="background: #f9fafb; padding: 40px; border-radius: 16px; text-align: center; box-shadow: 0 4px 6px rgba(0,0,0,0.05);">
                    ...
                    <div style="display: flex; gap: 16px; justify-content: center;">
                        ...
                        <a href="{{ route('register') }}" class="btn btn-outline" style="text-decoration: none;">Sign Up</a>
                    </div>
                </div>
            @endauth
        </div>
    ...
    <section style="padding: 80px 0; background: #f9fafb;">
        <div class="container">
            <div style="max-width: 800px; margin: 0 auto;">
                ...
                @if($userEntries && $userEntries->count() > 0)
                    ...
                    <div style="text-align: center; margin-top: 40px;">
                        <a href="{{ route('diary.my-stories') }}" class="btn btn-outline" style="text-decoration: none;">View All Stories</a>
                    </div>
                @else
