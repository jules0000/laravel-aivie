    ...
    <div class="container">
        <div style="max-width: 450px; margin: 0 auto; background: white; padding: 48px; border-radius: 16px; box-shadow: 0 10px 25px rgba(0,0,0,0.1);">
            ...
            <p style="text-align: center; margin-top: 24px; color: #6b7280;">
                ...
                <a href="<?php echo e(route('login')); ?>" style="color: #667eea; text-decoration: none; font-weight: 500;">Login</a>
            </p>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\documents2025901\Desktop\laravel\laravel-aivie\resources\views/auth/register.blade.php ENDPATH**/ ?>